        ...
        *,
        ...
        with torch.no_grad(), torch.autocast(
            ...
            if self.gain_mode == "hard_positive":
                ...
                # Dense bounded score: 1 is neutral, >1 means the expert has
                # lower BCE, and <1 means the expert is worse. Per-slice
                # scaling avoids assuming calibrated student/expert logits.
