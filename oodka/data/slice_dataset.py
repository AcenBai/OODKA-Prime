...
def make_biomedparse_block(
    ...
    *,
    ...
    """Build pseudo-RGB images as ``[Z,3,H,W]``.

    ``adjacent`` uses ``[z-1,z,z+1]``. ``center_repeat`` copies the center
    slice into all channels, avoiding through-plane misregistration in LGE.
    """
